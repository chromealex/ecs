namespace ME.ECS {
    ...
    using TName = EntityId;
    
    [Serializable]
    [StructLayout(LayoutKind.Sequential)]
    public readonly struct EntityId : IComparable, IConvertible, IFormattable, IComparable<TName>, IEquatable<TName>, ISerializable {

        public readonly TType v; // Do not rename (binary serialization)

        private EntityId(TType value) {

            this.v = value;

        }
        
        private EntityId(SerializationInfo info, StreamingContext context) {
