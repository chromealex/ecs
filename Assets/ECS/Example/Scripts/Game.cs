...
public class Game : MonoBehaviour {
    ...
    public GameObject pointSourceGameObject;
    ...
    public void Update() {
        ...
        if (this.world == null) {
            ...
            this.pointViewSourceId = this.world.RegisterViewSource<Point, UnityGameObjectProvider>(this.pointSourceGameObject);
            this.unitViewSourceId = this.world.RegisterViewSource<Unit, UnityParticlesProvider>(this.unitSource);
            this.unitViewSourceId2 = this.world.RegisterViewSource<Unit, UnityParticlesProvider>(this.unitSource2);
