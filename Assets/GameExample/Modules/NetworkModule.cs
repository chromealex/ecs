namespace ME.GameExample.Game.Modules {
    ...
    /// </summary>
    public class NetworkModule : ME.ECS.Network.NetworkModule<GameState> {
    ...
    public class FakeTransporter : ME.ECS.Network.ITransporter {
        ...
        public void Send(byte[] bytes) {
            ...
            if (this.connectToWorldId > 0) {
                ...
                var connectedWorld = ME.ECS.Worlds<GameState>.GetWorld(this.connectToWorldId);
