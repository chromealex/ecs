...
If you need to store managed data with custom copy interface, you could use **IStructCopyable<>** interface where you need to implement CopyFrom(in T other) and OnRecycle() methods.
```csharp
